...
TEST_FAST_API_STR = "app.core.click_cli.tests.fixture_commands.fixture_fast_api_init:test_fast_api_app"

fixture_fast_api = get_fast_api_app(TEST_FAST_API_STR)


fixture_commands_modules = [
    "app.core.click_cli.tests.fixture_commands.commands_a",
    "app.core.click_cli.tests.fixture_commands.commands_b"
]
