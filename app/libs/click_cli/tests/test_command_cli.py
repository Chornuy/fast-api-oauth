...
class TestCommandCli:
    ...
    async def test_fast_api_triggered_lifespan(
        ...
        mock_start_lifespan = mocker.patch(
            "app.libs.click_cli.tests.fixture_commands.fixture_fast_api_init.mock_start_something"
        )
        mock_close_lifespan = mocker.patch(
            "app.libs.click_cli.tests.fixture_commands.fixture_fast_api_init.mock_close_something"
        )
